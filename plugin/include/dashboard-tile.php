    ...
    function zfs_backup_dashboard_tile(): string {
        ...
        $row = function ($label, $value) {
            return '<tr><td style="padding-top:1px;padding-bottom:1px;border:0">'
                 . '<span class="grey-text" style="display:inline-block;width:160px;vertical-align:top">' . $label . '</span>'
        ...
        if (is_array($st)) {
            ...
            if ($orphans > 0) $rows .= $row('Verwaiste Datasets', '<span class="orange-text" style="font-weight:bold">' . $orphans . '</span>');
        } else {
